...
const themeCards: Record<JumpstartThemes, string[]> = {
  ...
  Phyrexian: ["Sheoldred, Whispering One"],
  ...
  Angels: ["Angelic Arbiter", "Baneslayer Angel", "Linvala, Keeper of Silence"],
  Dogs: ["Isamaru, Hound of Konda", "Pack Leader"],
  Enchanted: ["Ajani's Chosen", "Celestial Mantle", "Kor Spiritdancer"],
  ...
  Lightning: ["Ball Lightning", "Lightning Phoenix*"],
