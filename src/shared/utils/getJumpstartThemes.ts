...
const themeCards: Record<JumpstartThemes, string[]> = {
  ...
  Angels: ["Angelic Arbiter", "Baneslayer Angel", "Linvala, Keeper of Silence", "Serra’s Guardian"],
  Dogs: ["Isamaru, Hound of Konda", "Pack Leader"],
  Enchanted: ["Ajani's Chosen", "Celestial Mantle", "Kor Spiritdancer", "Archon of Sun’s Grace"],
